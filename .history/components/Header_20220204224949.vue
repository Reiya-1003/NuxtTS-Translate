...
<header class="head">
  <div class="container2 mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="botanarea lg:w-2/5  lg:justify-end lg:ml-0">
    ...
    　　</button>
      <nav class="translink  lg:w-2/5 flex-wrap items-center text-base md:ml-auto ml-3 " v-if="this.isLogin">
