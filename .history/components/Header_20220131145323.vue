...
<header class="head text-gray-600 body-font bg-green-400 ">
  <div class=" container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    　　</button>
      <button class="inline-flex items-center text-white font-bold bg-blue-500 hover:bg-blue-400 py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 focus:outline-none  rounded text-base mt-4 md:mt-0" @click="logout" v-if="this.isLogin">ログアウト
    　　</button>
