...
<header class="head text-gray-600 body-font bg-green-400 ">
  <div class=" container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    　　</button>
      <button class="p-0 inline-flex items-center text-white font-bold bg-green-500 hover:bg-green-400 border-b-4 border-green-700 hover:border-green-500 focus:outline-none  rounded text-xs mt-2 md:mt-0" @click="logout" v-if="this.isLogin">ログアウト
    　　</button>
