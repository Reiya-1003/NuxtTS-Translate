  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="botanarea lg:w-2/5 flex lg:justify-end ml-5 lg:ml-0">
      ...
      <div class="inline-flex items-center  border-0 py-1 px-3 focus:outline-none rounded text-xs md:mt-0" v-if="this.username">
           {{this.username}}
    　　      </div>
      <button class="loginbotan inline-flex items-center text-white font-bold bg-green-500 hover:bg-green-400 border-b-4 border-green-700 hover:border-green-500 focus:outline-none  rounded text-xs md:mt-0" @click="Login" v-if="!this.isLogin">ログイン
    　　</button>
