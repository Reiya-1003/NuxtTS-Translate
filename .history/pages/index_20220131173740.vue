...
　　<div>
        ...
        <main>
     　　　　<div>
     　　　　　　<form class="area">日本語を入力
      　　　　　　　　 <textarea v-model="list.japan" class="area__textja"></textarea>
       　　　　　　　　<button type="submit" @click="Enchange">英語に翻訳</button>
     　　　　　　</form>
    　　　　　 <div>翻訳結果チェック：{{Enitems}}</div>
     　　　 </div>
    　　　　 <div>
     　　　　　　<form class="area">英語を入力
       　　　　　　　　<textarea v-model="list.english" class="area__texten"></textarea>
       　　　　　　　　<button type="submit" @click="Jachange">日本語に翻訳</button>
     　　　　　　</form>
