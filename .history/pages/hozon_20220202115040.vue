...
data(){
  ...
  username:"",
  itemComponent: Item,
  items: [{uid: 'unique_1', text: 'abc'}, {uid: 'unique_2', text: 'xyz'}, {uid: 'unique_3', text: 'xyz'}, {uid: 'unique_4', text: 'xyz'}, {uid: 'unique_5', text: 'xyz'}, {uid: 'unique_6', text: 'xyz'}, {uid: 'unique_7', text: 'xyz'}, {uid: 'unique_8', text: 'xyz'}, {uid: 'unique_9', text: 'xyz'}, {uid: 'unique_10', text: 'xyz'}, {uid: 'unique_11', text: 'xyz'}, {uid: 'unique_12', text: 'xyz'}, {uid: 'unique_13', text: 'xyz'}, {uid: 'unique_14', text: 'xyz'}, {uid: 'unique_15', text: 'xyz'}, {uid: 'unique_16', text: 'xyz'}, {uid: 'unique_17', text: 'xyz'}, {uid: 'unique_18', text: 'xyz'}, {uid: 'unique_19', text: 'xyz'}, {uid: 'unique_20', text: 'xyz'}, {uid: 'unique_21', text: 'xyz'}, {uid: 'unique_22', text: 'xyz'}, ]
