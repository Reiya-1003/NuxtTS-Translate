...
　　<div>
        ...
        <main>
     　　　　<div>
     　　　　　　<form class="area" @submit.prevent="Enchange">
      　　　　　　　　 <input type="text" v-model="list.japan" placeholder="日本語を入力" class="area__textja">
       　　　　　　　
     　　　　　　</form>
    　　　　　 <div>翻訳結果チェック：{{Enitems}}</div>
     　　　 </div>
    　　　　 <div>
     　　　　　　<form class="area" @submit.prevent="Jachange">
       　　　　　　　　<input type="text" v-model="list.english" placeholder="English" class="area__texten">
       　　　　　　　　
     　　　　　　</form>
